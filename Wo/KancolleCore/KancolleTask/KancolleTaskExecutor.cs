...
using Wo.KancolleCore.KancolleBattle;
using Wo.KancolleCore.KancolleNavigation;
using Wo.Utils;
using static Wo.KancolleCore.KancolleTask.KancolleTaskResultErrors;
...
namespace Wo.KancolleCore.KancolleTask
{
    ...
    /// </summary>
    public class KancolleTaskExecutor
    {
        internal event Action<KancolleTaskExecutor, KancolleTaskResult> OnTaskFinished;
        internal event Action<KancolleTaskExecutor, NotifyCollectionChangedEventArgs> OnTaskChanged;
        internal event Action<KancolleTaskExecutor> OnTaskStart;
        ...
        private KancolleSceneNavigator navigator = new KancolleSceneNavigator();
        ...
        public void Start()
        {
            if (taskThread == null)
            {
                taskThread = new Thread(new ThreadStart(TaskThreadHandler));
